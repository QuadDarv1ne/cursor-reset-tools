...
**Примечание:** routes/reset.js (1871 строка) содержит дубли endpoints с новыми роутами (~350 строк):
- `/proxy/*` (16 endpoints) - дублируются с routes/proxy.js
- `/dns/*` (5 endpoints) - дублируются с routes/network.js
- `/vpn/*` (11 endpoints) - дублируются с routes/network.js
Удаление не критично (роуты имеют приоритет), рекомендуется для сокращения файла.
